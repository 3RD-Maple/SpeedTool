...
public sealed class SettingsWindow : Window
{
    ...
    private Vector3 textColor = new Vector3(0.3f, 0.7f, 0.9f);
    ...
    protected override void OnUI(double dt)
    {
        ...
        ImGui.Begin("SettingsWindow", ImGuiWindowFlags.NoResize | ImGuiWindowFlags.NoDecoration | ImGuiWindowFlags.NoTitleBar | ImGuiWindowFlags.NoMove);
        ...
        if(ImGui.ColorButton("Text color", new Vector4(textColor, 1.0f), ImGuiColorEditFlags.None, new Vector2(25f, 25f)))
        {
            ImGui.OpenPopup("TextColorPicker");
        }
